...
{
	[Serializable]
	public class BooleanBinding : Expression, ISerializable
	{
		private readonly string id;
		private Expression[] param;

		public BooleanBinding(string id, params Expression[] param)
		{
			this.id = id;
			this.param = param;
		}
		...
		public override Value Evaluate(RumorScope scope, RumorBindings bindings)
		{
			...
			{
				throw new VariableTypeException(
					"Function \"" + id + "\" did not return a boolean!"
				);
			}
		...
		{
			return Equals(obj as BooleanBinding);
		}

		public bool Equals(BooleanBinding other)
		{
			if (other == null)
			{
				return false;
