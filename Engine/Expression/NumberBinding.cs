...
{
	[Serializable]
	public class NumberBinding : Expression, ISerializable
	{
		private readonly string id;
		private Expression[] param;

		public NumberBinding(string id, params Expression[] param)
		{
			this.id = id;
			this.param = param;
		}
		...
		public override Value Evaluate(RumorScope scope, RumorBindings bindings)
		{
			...
			{
				throw new VariableTypeException(
					"Function \"" + id + "\" did not return a double!"
				);
			}
		...
		{
			return Equals(obj as NumberBinding);
		}

		public bool Equals(NumberBinding other)
		{
			if (other == null)
			{
				return false;
