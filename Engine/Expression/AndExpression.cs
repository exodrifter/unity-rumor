...
{
	[Serializable]
	public class AndExpression : Expression, ISerializable
	{
		...
		{
			return l.Evaluate(scope, bindings).AsBoolean()
				&& r.Evaluate(scope, bindings).AsBoolean();
		}
		...
		public AndExpression(SerializationInfo info, StreamingContext context)
		{
